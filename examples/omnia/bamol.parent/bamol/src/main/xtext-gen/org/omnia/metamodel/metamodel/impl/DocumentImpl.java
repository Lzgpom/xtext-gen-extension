 ...
 * </p>
 * <ul>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.DocumentImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.DocumentImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.DocumentImpl#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.DocumentImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.DocumentImpl#getEntityBehaviours <em>Entity Behaviours</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.DocumentImpl#getDataBehaviours <em>Data Behaviours</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.DocumentImpl#getBehaviourNamespaces <em>Behaviour Namespaces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DocumentImpl extends EntityImpl implements Document
{
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.DOCUMENT__DESCRIPTION, oldDescription, description));
  }
  ...
  public DataSource getDataSource()
  {
    if (dataSource != null && dataSource.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetamodelPackage.DOCUMENT__DATA_SOURCE, oldDataSource, dataSource));
      }
    }
    return dataSource;
  }
  ...
  public void setDataSource(DataSource newDataSource)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.DOCUMENT__DATA_SOURCE, oldDataSource, dataSource));
  }
  ...
  public EList<MAttribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<MAttribute>(MAttribute.class, this, MetamodelPackage.DOCUMENT__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public EList<EntityBehaviour> getEntityBehaviours()
  {
    ...
    {
      entityBehaviours = new EObjectContainmentEList<EntityBehaviour>(EntityBehaviour.class, this, MetamodelPackage.DOCUMENT__ENTITY_BEHAVIOURS);
    }
  ...
  public EList<DataBehaviour> getDataBehaviours()
  {
    ...
    {
      dataBehaviours = new EObjectContainmentEList<DataBehaviour>(DataBehaviour.class, this, MetamodelPackage.DOCUMENT__DATA_BEHAVIOURS);
    }
  ...
  public EList<BehaviourNamespace> getBehaviourNamespaces()
  {
    ...
    {
      behaviourNamespaces = new EObjectContainmentEList<BehaviourNamespace>(BehaviourNamespace.class, this, MetamodelPackage.DOCUMENT__BEHAVIOUR_NAMESPACES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MetamodelPackage.DOCUMENT__ATTRIBUTES:
        return ((InternalEList<?>)getAttributes()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.DOCUMENT__ENTITY_BEHAVIOURS:
        return ((InternalEList<?>)getEntityBehaviours()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.DOCUMENT__DATA_BEHAVIOURS:
        return ((InternalEList<?>)getDataBehaviours()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.DOCUMENT__BEHAVIOUR_NAMESPACES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MetamodelPackage.DOCUMENT__NAME:
        return getName();
      case MetamodelPackage.DOCUMENT__DESCRIPTION:
        return getDescription();
      case MetamodelPackage.DOCUMENT__DATA_SOURCE:
