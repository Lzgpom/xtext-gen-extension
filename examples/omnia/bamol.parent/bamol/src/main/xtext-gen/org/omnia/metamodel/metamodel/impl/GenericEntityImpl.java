...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Generic Entity</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.GenericEntityImpl#isIsRoot <em>Is Root</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.GenericEntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.GenericEntityImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.GenericEntityImpl#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.GenericEntityImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.GenericEntityImpl#getEntityBehaviours <em>Entity Behaviours</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.GenericEntityImpl#getDataBehaviours <em>Data Behaviours</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.GenericEntityImpl#getBehaviourNamespaces <em>Behaviour Namespaces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenericEntityImpl extends EntityImpl implements GenericEntity
{
  /**
  ...
  {
    return MetamodelPackage.Literals.GENERIC_ENTITY;
  }
  ...
  public void setIsRoot(boolean newIsRoot)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.GENERIC_ENTITY__IS_ROOT, oldIsRoot, isRoot));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.GENERIC_ENTITY__NAME, oldName, name));
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.GENERIC_ENTITY__DESCRIPTION, oldDescription, description));
  }
  ...
  public DataSource getDataSource()
  {
    if (dataSource != null && dataSource.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetamodelPackage.GENERIC_ENTITY__DATA_SOURCE, oldDataSource, dataSource));
      }
    }
    return dataSource;
  }
  ...
  public void setDataSource(DataSource newDataSource)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.GENERIC_ENTITY__DATA_SOURCE, oldDataSource, dataSource));
  }
  ...
  public EList<MAttribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<MAttribute>(MAttribute.class, this, MetamodelPackage.GENERIC_ENTITY__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public EList<EntityBehaviour> getEntityBehaviours()
  {
    ...
    {
      entityBehaviours = new EObjectContainmentEList<EntityBehaviour>(EntityBehaviour.class, this, MetamodelPackage.GENERIC_ENTITY__ENTITY_BEHAVIOURS);
    }
  ...
  public EList<DataBehaviour> getDataBehaviours()
  {
    ...
    {
      dataBehaviours = new EObjectContainmentEList<DataBehaviour>(DataBehaviour.class, this, MetamodelPackage.GENERIC_ENTITY__DATA_BEHAVIOURS);
    }
  ...
  public EList<BehaviourNamespace> getBehaviourNamespaces()
  {
    ...
    {
      behaviourNamespaces = new EObjectContainmentEList<BehaviourNamespace>(BehaviourNamespace.class, this, MetamodelPackage.GENERIC_ENTITY__BEHAVIOUR_NAMESPACES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MetamodelPackage.GENERIC_ENTITY__ATTRIBUTES:
        return ((InternalEList<?>)getAttributes()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.GENERIC_ENTITY__ENTITY_BEHAVIOURS:
        return ((InternalEList<?>)getEntityBehaviours()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.GENERIC_ENTITY__DATA_BEHAVIOURS:
        return ((InternalEList<?>)getDataBehaviours()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.GENERIC_ENTITY__BEHAVIOUR_NAMESPACES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MetamodelPackage.GENERIC_ENTITY__IS_ROOT:
        return isIsRoot();
      case MetamodelPackage.GENERIC_ENTITY__NAME:
        return getName();
      case MetamodelPackage.GENERIC_ENTITY__DESCRIPTION:
        return getDescription();
      case MetamodelPackage.GENERIC_ENTITY__DATA_SOURCE:
