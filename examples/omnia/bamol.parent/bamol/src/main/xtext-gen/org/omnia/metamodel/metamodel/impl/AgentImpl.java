 ...
 * </p>
 * <ul>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.AgentImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.AgentImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.AgentImpl#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.AgentImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.AgentImpl#getEntityBehaviours <em>Entity Behaviours</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.AgentImpl#getDataBehaviours <em>Data Behaviours</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.AgentImpl#getBehaviourNamespaces <em>Behaviour Namespaces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AgentImpl extends EntityImpl implements Agent
{
  ...
  {
    return MetamodelPackage.Literals.AGENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.AGENT__NAME, oldName, name));
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.AGENT__DESCRIPTION, oldDescription, description));
  }
  ...
  public DataSource getDataSource()
  {
    if (dataSource != null && dataSource.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetamodelPackage.AGENT__DATA_SOURCE, oldDataSource, dataSource));
      }
    }
    return dataSource;
  }
  ...
  public void setDataSource(DataSource newDataSource)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.AGENT__DATA_SOURCE, oldDataSource, dataSource));
  }
  ...
  public EList<MAttribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<MAttribute>(MAttribute.class, this, MetamodelPackage.AGENT__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public EList<EntityBehaviour> getEntityBehaviours()
  {
    ...
    {
      entityBehaviours = new EObjectContainmentEList<EntityBehaviour>(EntityBehaviour.class, this, MetamodelPackage.AGENT__ENTITY_BEHAVIOURS);
    }
  ...
  public EList<DataBehaviour> getDataBehaviours()
  {
    ...
    {
      dataBehaviours = new EObjectContainmentEList<DataBehaviour>(DataBehaviour.class, this, MetamodelPackage.AGENT__DATA_BEHAVIOURS);
    }
  ...
  public EList<BehaviourNamespace> getBehaviourNamespaces()
  {
    ...
    {
      behaviourNamespaces = new EObjectContainmentEList<BehaviourNamespace>(BehaviourNamespace.class, this, MetamodelPackage.AGENT__BEHAVIOUR_NAMESPACES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MetamodelPackage.AGENT__ATTRIBUTES:
        return ((InternalEList<?>)getAttributes()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.AGENT__ENTITY_BEHAVIOURS:
        return ((InternalEList<?>)getEntityBehaviours()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.AGENT__DATA_BEHAVIOURS:
        return ((InternalEList<?>)getDataBehaviours()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.AGENT__BEHAVIOUR_NAMESPACES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MetamodelPackage.AGENT__NAME:
        return getName();
      case MetamodelPackage.AGENT__DESCRIPTION:
        return getDescription();
      case MetamodelPackage.AGENT__DATA_SOURCE:
