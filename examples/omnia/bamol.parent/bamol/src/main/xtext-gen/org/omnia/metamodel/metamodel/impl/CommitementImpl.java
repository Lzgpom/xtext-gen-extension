...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Commitement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.CommitementImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.CommitementImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.CommitementImpl#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.CommitementImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.CommitementImpl#getEntityBehaviours <em>Entity Behaviours</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.CommitementImpl#getDataBehaviours <em>Data Behaviours</em>}</li>
 *   <li>{@link org.omnia.metamodel.metamodel.impl.CommitementImpl#getBehaviourNamespaces <em>Behaviour Namespaces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommitementImpl extends EntityImpl implements Commitement
{
  /**
  ...
  {
    return MetamodelPackage.Literals.COMMITEMENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.COMMITEMENT__NAME, oldName, name));
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.COMMITEMENT__DESCRIPTION, oldDescription, description));
  }
  ...
  public DataSource getDataSource()
  {
    if (dataSource != null && dataSource.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetamodelPackage.COMMITEMENT__DATA_SOURCE, oldDataSource, dataSource));
      }
    }
    return dataSource;
  }
  ...
  public void setDataSource(DataSource newDataSource)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.COMMITEMENT__DATA_SOURCE, oldDataSource, dataSource));
  }
  ...
  public EList<MAttribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<MAttribute>(MAttribute.class, this, MetamodelPackage.COMMITEMENT__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public EList<EntityBehaviour> getEntityBehaviours()
  {
    ...
    {
      entityBehaviours = new EObjectContainmentEList<EntityBehaviour>(EntityBehaviour.class, this, MetamodelPackage.COMMITEMENT__ENTITY_BEHAVIOURS);
    }
  ...
  public EList<DataBehaviour> getDataBehaviours()
  {
    ...
    {
      dataBehaviours = new EObjectContainmentEList<DataBehaviour>(DataBehaviour.class, this, MetamodelPackage.COMMITEMENT__DATA_BEHAVIOURS);
    }
  ...
  public EList<BehaviourNamespace> getBehaviourNamespaces()
  {
    ...
    {
      behaviourNamespaces = new EObjectContainmentEList<BehaviourNamespace>(BehaviourNamespace.class, this, MetamodelPackage.COMMITEMENT__BEHAVIOUR_NAMESPACES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MetamodelPackage.COMMITEMENT__ATTRIBUTES:
        return ((InternalEList<?>)getAttributes()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.COMMITEMENT__ENTITY_BEHAVIOURS:
        return ((InternalEList<?>)getEntityBehaviours()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.COMMITEMENT__DATA_BEHAVIOURS:
        return ((InternalEList<?>)getDataBehaviours()).basicRemove(otherEnd, msgs);
      case MetamodelPackage.COMMITEMENT__BEHAVIOUR_NAMESPACES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MetamodelPackage.COMMITEMENT__NAME:
        return getName();
      case MetamodelPackage.COMMITEMENT__DESCRIPTION:
        return getDescription();
      case MetamodelPackage.COMMITEMENT__DATA_SOURCE:
