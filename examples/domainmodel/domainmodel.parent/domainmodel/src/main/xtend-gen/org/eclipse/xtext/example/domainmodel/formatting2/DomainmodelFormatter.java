...
public class DomainmodelFormatter extends XbaseFormatter {
  ...
  protected void _format(final DomainModel domainModel, @Extension final IFormattableDocument document) {
    document.<XImportSection>format(domainModel.getImportSection());
  ...
  public void format(final Object packageDeclaration, final IFormattableDocument document) {
    if (packageDeclaration instanceof JvmTypeParameter) {
      ...
      return;
    } else if (packageDeclaration instanceof DomainModel) {
      _format((DomainModel)packageDeclaration, document);
      return;
